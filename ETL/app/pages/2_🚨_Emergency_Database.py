...
df_volcano = df_erupting[df_erupting['Volcano_Name'] == volcano_selected]
...
if not df_roads.empty:
    ...
    with col_a:
        ...
        st.markdown(
            f"""
            <div style="margin-top: 15px; padding: 10px; background-color: #D3D3D3; border-radius: 5px; border-left: 4px solid #ff6b6b;">
    ...
    with col_c:
        ...
        legend_items = [
            ...
            <div style="display: flex; align-items: center; margin: 8px 0;">
                ...
                "></div>
                <span style="color: black;">{service.replace('_', ' ').title()}</span>
            </div>
            """
        ...
        st.markdown(
            f"""
            <div style="margin-top: 15px; padding: 12px; background-color: #D3D3D3; border-radius: 5px; border-left: 4px solid #ff4b4b;">
                <h4 style="margin-bottom: 10px; color: #333;">⚠️ Emergency Services</h4>
                {''.join(legend_items)}
            </div>
            """,
            unsafe_allow_html=True
...
if not df_essential_services.empty:
    ...
    with col_d:
        ...
        st.markdown(
            f"""
            <div style="margin-top: 15px; padding: 12px; background-color: #D3D3D3; border-radius: 5px; border-left: 4px solid #ff4b4b;">
                <h4 style="margin-bottom: 10px; color: #333;">🏪 Essential Services</h4>
...
if not df_amenities.empty:
    ...
    with col_e:
        ...
        st.markdown(
            f"""
            <div style="margin-top: 15px; padding: 12px; background-color: #D3D3D3; border-radius: 5px; border-left: 4px solid #ff4b4b;">
                <h4 style="margin-bottom: 10px; color: #333;">🎓 Educational Facilities and others</h4>
